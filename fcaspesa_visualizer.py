...
cell_arr[0][0] = cell_raw[-9]
cell_arr[0][1] = cell_raw[-8]
cell_arr[0][2] = cell_raw[-7]
cell_arr[1][0] = cell_raw[-6]
cell_arr[1][1] = cell_raw[-5]
cell_arr[1][2] = cell_raw[-4]
cell_arr[2][0] = cell_raw[-3]
cell_arr[2][1] = cell_raw[-2]
cell_arr[2][2] = cell_raw[-1]
print cell_arr
xyz_file = xyz_file[2:]
