...
xyz_file = open(xyz_file_name,"r").readlines()
at_names = []
x_coords = []
y_coords = []
z_coords = []
...
cell_raw = cell_raw.split()
cell_arr[0][0] = cell_raw[4]
cell_arr[0][1] = cell_raw[5]
cell_arr[0][2] = cell_raw[6]
cell_arr[1][0] = cell_raw[7]
cell_arr[1][1] = cell_raw[8]
cell_arr[1][2] = cell_raw[9]
cell_arr[2][0] = cell_raw[10]
cell_arr[2][1] = cell_raw[11]
cell_arr[2][2] = cell_raw[12]
print cell_arr
xyz_file = xyz_file[2:]
